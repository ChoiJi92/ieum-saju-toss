...
const CAREER_BODY_BY_ILGAN: Record<Stem, string> = {
  甲: '큰 나무처럼 성장 욕구가 강하고 리더십이 자연스러운 성향이에요. 처음부터 끝까지 본인이 끌고 가는 일에 강점이 있어요. 교육·기획·창업·관리자 자리에 잘 어울려요. 단 너무 자기 방향만 보다 협업이 막힐 수 있으니 옆에 유연한 사람을 두면 균형이 잡혀요.',
  乙: '바람에 부드럽게 휘는 풀처럼 유연하고 세심한 성향이에요. 큰 줄기보다 디테일을 챙기는 자리에서 빛나요. 디자인·기획·인사·상담·중간 관리자 자리에 잘 어울려요. 강한 사람 옆에서 조력자로 빛나는 자리도 본인 결에 잘 맞아요.',
  丙: '한낮의 태양처럼 표현력과 영향력이 큰 성향이에요. 사람 앞에 서서 빛나는 자리에 강해요. 발표·강의·미디어·영업·마케팅·연예 자리에 잘 어울려요. 단 감정 기복이 클 수 있으니 꾸준한 루틴을 의식적으로 챙겨주세요.',
  丁: '촛불·별의 빛처럼 안에서 깊게 빛나는 성향이에요. 한 분야를 깊게 파고드는 일에 강해요. 작가·연구원·디자이너·예술·심리상담 자리에 잘 어울려요. 직관이 뛰어나니 직관을 따라가는 결정이 의외로 잘 맞아요.',
  戊: '큰 산처럼 묵직하고 신뢰감 있는 성향이에요. 흔들리지 않는 안정감이 무기예요. 부동산·건설·중개·자산관리·관리자 자리에 잘 어울려요. 단 너무 무거우면 변화에 둔할 수 있으니 새로운 시도도 가끔 챙겨주세요.',
  己: '비옥한 들판처럼 포용력이 큰 성향이에요. 사람을 키우고 모이게 하는 자질이 있어요. 교육·인사·서비스·요식업·중개 자리에 잘 어울려요. 어머니 같은 따뜻함이 무기지만, 경계는 명확히 그어두는 게 진짜 베푸는 사람이 되는 길이에요.',
  庚: '강철·도끼처럼 결단력이 강한 성향이에요. 옳고 그름이 분명한 일에 강해요. 군·경찰·법무·외과·금융·CEO 자리에 잘 어울려요. 단 직선적이면 사람을 다치게 할 수 있으니 톤은 한 박자 부드럽게 가져가주세요.',
  辛: '하얀 보석·잘 닦인 칼처럼 섬세하고 완벽주의적인 성향이에요. 디테일을 보는 눈이 뛰어나요. 의학·법무·회계·디자이너·전문직 자리에 잘 어울려요. "완벽이 아닌 완료"를 키워드로 가져가면 시작이 빨라져요.',
  壬: '큰 강·바다처럼 흐름을 읽는 자유로운 성향이에요. 다양한 사람·정보 사이를 오가는 일에 강해요. IT·유통·언론·교통·무역 자리에 잘 어울려요. 단 너무 흐르다 자기 자리를 놓칠 수 있으니, 방향성을 정해주는 사람과 함께면 시너지가 폭발해요.',
  癸: '이슬비·맑은 샘물처럼 차분하고 꾸준한 성향이에요. 조용히 스며드는 영향력이 있어요. 연구·기획·상담·금융·바이오 자리에 잘 어울려요. 가끔 자기 목소리를 내는 자리를 만들어주면 존재감이 더 커져요.',
};
