...
/** 부족한 오행별 건강 팁 6개 (아코디언, 3개씩 일별 로테이션) */
...
> = {
  wood: [
    ...
    { ic: '👁️', lbl: '눈 피로 줄이기', sub: '20-20-20 룰',
      detail: '木은 눈과 시력을 관장해요. 화면을 오래 보는 날엔 20분마다 20초간 6m(20피트) 거리를 바라보는 20-20-20 룰을 지켜주세요. 눈 주변 근육 긴장이 풀리고 두통도 줄어들어요. 자기 전 온찜질도 좋아요.' },
    { ic: '🍵', lbl: '신맛 허브차 한 잔', sub: '로즈힙·히비스커스',
      detail: '木 기운 보충엔 신맛이 핵심이에요. 로즈힙·히비스커스·매실차처럼 새콤한 허브차를 오전에 한 잔 챙겨주세요. 간 해독을 돕고 쌓인 피로 물질 배출에도 도움이 돼요. 뜨겁게 마시는 게 더 효과적이에요.' },
    { ic: '😮‍💨', lbl: '화(火) 조절 루틴', sub: '5분 호흡 명상',
      detail: '木이 약하면 감정 기복과 짜증이 쉽게 올라와요. 하루 5분, 4초 들이마시고 4초 내쉬는 복식 호흡을 해주세요. 간의 기운이 잘 흐르면 감정도 안정돼요. 아침 기상 직후 또는 잠자기 전이 가장 좋아요.' },
  ],
  fire: [
    ...
    { ic: '🏃', lbl: '인터벌 유산소', sub: '주 3회 20분',
      detail: '火는 심장과 혈관을 관장해요. 주 3회 빠르게 걷기·가벼운 조깅처럼 숨이 약간 찰 정도의 인터벌 유산소를 해주세요. 심박수를 올렸다 내리는 리듬이 심장 기능을 튼튼하게 만들어요. 운동 후 충분한 수분 섭취도 잊지 마세요.' },
    { ic: '💤', lbl: '낮잠 15분', sub: '오후 집중력 충전',
      detail: '火 기운이 약하면 오후 2~3시쯤 집중력이 뚝 떨어져요. 점심 후 15분 낮잠이 심장 부담을 줄이고 오후 에너지를 회복시켜줘요. 알람 맞추고 소파나 의자에서 짧게 자는 것만으로도 충분해요. 30분 이상은 오히려 역효과.' },
    { ic: '🚫', lbl: '저녁 카페인 컷', sub: '오후 2시 이후 NO',
      detail: '火 기운이 약한 사람은 카페인에 더 민감하게 반응해요. 심장 두근거림·불면이 심해지는 원인 중 하나예요. 오후 2시 이후엔 커피·에너지 드링크 대신 따뜻한 카모마일차나 보리차로 바꿔주세요. 작은 변화가 수면 질을 크게 바꿔요.' },
  ],
  earth: [
    ...
    { ic: '🫖', lbl: '아침 따뜻한 물 한 잔', sub: '공복에 챙기기',
      detail: '土는 비장과 위를 관장해요. 아침 공복에 따뜻한 물(40~50도) 한 컵을 마시면 위장이 부드럽게 깨어나요. 찬물은 비위 기운을 바로 꺾어버리니 주의해주세요. 레몬 한 조각을 넣으면 소화 효소 분비를 더 자극해줘요.' },
    { ic: '🦷', lbl: '꼭꼭 씹기 습관', sub: '한 입 30번',
      detail: '土 기운이 약하면 소화력이 떨어져서 잘 씹는 것만으로도 위 부담이 크게 줄어요. 한 입에 최소 20~30번 씹는 습관을 들여주세요. 침 분비가 늘면 소화 효소가 활성화되고 포만감도 빨리 와서 과식도 자연스럽게 줄어요.' },
    { ic: '🌙', lbl: '야식 컷 룰', sub: '자기 3시간 전 금식',
      detail: '土가 약한 사람은 야식이 위장에 직접적인 부담으로 이어져요. 자기 3시간 전부터는 음식을 끊어주세요. 위가 쉬는 동안 다음 날 소화력이 회복돼요. 야식이 당길 땐 따뜻한 보리차 한 잔으로 대신해주세요.' },
  ],
  metal: [
    ...
    { ic: '🪟', lbl: '환기 루틴', sub: '아침저녁 10분씩',
      detail: '金은 폐와 대장·피부를 관장해요. 탁한 실내 공기는 폐 기운을 바로 약화시켜요. 아침 기상 후·자기 전 창문을 10분씩 열어 환기해주세요. 실내 미세먼지 농도가 낮아지고 폐 기능 회복에 직접 도움이 돼요.' },
    { ic: '🥗', lbl: '유산균·식이섬유 챙기기', sub: '대장 건강 루틴',
      detail: '金이 약하면 대장 운동이 느려져 변비·복부 불편이 잘 와요. 매일 아침 유산균 한 알과 식이섬유가 풍부한 채소(브로콜리·양배추·사과)를 챙겨주세요. 장내 환경이 좋아지면 피부 트러블도 함께 줄어들어요.' },
    { ic: '🧴', lbl: '피부 보습 루틴', sub: '샤워 후 3분 안에',
      detail: '金 기운이 약하면 피부 장벽이 약해져 건조함과 트러블이 잦아요. 샤워 후 3분 이내에 보습제를 발라 수분을 가두어주세요. 알코올 성분 있는 제품은 피하고, 가습기로 실내 습도를 50~60%로 유지하면 피부와 기관지 모두 편해져요.' },
  ],
  water: [
    ...
    { ic: '🦵', lbl: '하체 근력 운동', sub: '스쿼트·계단 걷기',
      detail: '水는 신장·방광과 함께 허리·무릎·관절을 관장해요. 허벅지와 엉덩이 근력이 강해지면 관절 부담이 줄어요. 매일 스쿼트 10개, 계단 오르내리기로 시작해주세요. 무리하지 않고 꾸준히 하는 게 핵심이에요.' },
    { ic: '🧦', lbl: '발 따뜻하게', sub: '수면 양말·족욕',
      detail: '水 기운이 약하면 발이 차갑고 몸 전체의 냉증이 심해져요. 수면 양말을 신거나 자기 전 따뜻한 물(40도)에 15분 족욕을 해주세요. 발 온도가 올라가면 수면 유도가 쉬워지고 신장·방광 기능 회복에도 도움이 돼요.' },
    { ic: '🧂', lbl: '저염 습관', sub: '국물은 반만',
      detail: '水 기운이 약한 사람은 짠 음식이 신장에 곧바로 부담으로 이어져요. 국·찌개는 국물을 반만 마시고 나트륨이 적은 음식을 선택해주세요. 대신 물을 충분히 마셔 노폐물을 자연스럽게 배출해주는 게 신장 케어의 기본이에요.' },
  ],
};
...
export function healthForecast(
  ...
  return {
    ...
    tips: rotateBySeed(seed, `${ymd}_health_tips`, TIPS_BY_WEAK[weakOhaeng], 3),
  };
}
