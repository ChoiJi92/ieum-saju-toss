...
// 근거: iztro(zh-CN) 廟旺利陷 테이블 전수 추출 — scripts/gen-jamidusu-brightness.ts 로 재생성 가능
export const BRIGHTNESS_TABLE: Record<MainStar, Brightness[]> = {
  자미: ['평', '묘', '왕', '왕', '득', '왕', '묘', '묘', '왕', '왕', '득', '왕'], // 자축인묘진사오미신유술해
  천기: ['묘', '함', '득', '왕', '리', '평', '묘', '함', '득', '왕', '리', '평'], // 자축인묘진사오미신유술해
  태양: ['함', '불', '왕', '묘', '왕', '왕', '왕', '득', '득', '함', '불', '함'], // 자축인묘진사오미신유술해
  무곡: ['왕', '묘', '득', '리', '묘', '평', '왕', '묘', '득', '리', '묘', '평'], // 자축인묘진사오미신유술해
  천동: ['왕', '불', '리', '평', '평', '묘', '함', '불', '왕', '평', '평', '묘'], // 자축인묘진사오미신유술해
  염정: ['평', '리', '묘', '평', '리', '함', '평', '리', '묘', '평', '리', '함'], // 자축인묘진사오미신유술해
  천부: ['묘', '묘', '묘', '득', '묘', '득', '왕', '묘', '득', '왕', '묘', '득'], // 자축인묘진사오미신유술해
  태음: ['묘', '묘', '왕', '함', '함', '함', '불', '불', '리', '불', '왕', '묘'], // 자축인묘진사오미신유술해
  탐랑: ['왕', '묘', '평', '리', '묘', '함', '왕', '묘', '평', '리', '묘', '함'], // 자축인묘진사오미신유술해
  거문: ['왕', '불', '묘', '묘', '함', '왕', '왕', '불', '묘', '묘', '함', '왕'], // 자축인묘진사오미신유술해
  천상: ['묘', '묘', '묘', '함', '득', '득', '묘', '득', '묘', '함', '득', '득'], // 자축인묘진사오미신유술해
  천량: ['묘', '왕', '묘', '묘', '묘', '함', '묘', '왕', '함', '득', '묘', '함'], // 자축인묘진사오미신유술해
  칠살: ['왕', '묘', '묘', '왕', '묘', '평', '왕', '묘', '묘', '묘', '묘', '평'], // 자축인묘진사오미신유술해
  파군: ['묘', '왕', '득', '함', '왕', '평', '묘', '왕', '득', '함', '왕', '평'], // 자축인묘진사오미신유술해
};
